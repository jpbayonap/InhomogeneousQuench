...
MMA_DELTA_BATCH_SIZE="${MMA_DELTA_BATCH_SIZE:-4}"
MMA_DELTA_BATCH_INDEX="${MMA_DELTA_BATCH_INDEX:-0}"
MMA_CHI_ONLY="${MMA_CHI_ONLY:-false}"
...
echo "MMA_BETA=$MMA_BETA"
echo "MMA_RUN_DIAGNOSTICS=$MMA_RUN_DIAGNOSTICS"
echo "MMA_PROFILE_MODE=$MMA_PROFILE_MODE"
echo "MMA_SKIP_CHI=$MMA_SKIP_CHI"
echo "MMA_DELTA_BATCH_SIZE=$MMA_DELTA_BATCH_SIZE"
echo "MMA_DELTA_BATCH_INDEX=$MMA_DELTA_BATCH_INDEX"
echo "MMA_CHI_ONLY=$MMA_CHI_ONLY"
...
apptainer exec \
  ...
  export MMA_BETA=$MMA_BETA
  export MMA_RUN_DIAGNOSTICS=$MMA_RUN_DIAGNOSTICS
  export MMA_PROFILE_MODE=$MMA_PROFILE_MODE
  export MMA_SKIP_CHI=$MMA_SKIP_CHI
  export MMA_DELTA_BATCH_SIZE=$MMA_DELTA_BATCH_SIZE
  export MMA_DELTA_BATCH_INDEX=$MMA_DELTA_BATCH_INDEX
  export MMA_CHI_ONLY=$MMA_CHI_ONLY
